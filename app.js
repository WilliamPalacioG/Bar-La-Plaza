...
const MENU = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Refrescos",description: "Tea Maracuya, Melocoton Sin Azucar, Frutos Rojos, Tinto de Verano Limon 00.", price: 2.60 },
      { name: "Zumos", price: 2.00 },
      { name: "Jarra de Cerveza", price: 3.50 },
      { name: "Jarra de Vino", price: 3.50 },
      { name: "Radler de Limon", price: 2.50 },
      { name: "Copa de Cerveza", price: 2.60 },
      { name: "Copa de Vino", price: 2.00 },
      { name: "Copa de Vino con Casera", price: 2.50 },
      { name: "Café con leche / Café Solo / Cortado", price: 1.50 },
      { name: "Cafe Bombón / Capuchino / Carajillo", price: 2.00 },
      { name: "Cafe Belmonte", price: 2.70 },
      { name: "Cafe Descafeinado de Sobre", price: 1.60 },
      { name: "Cola Cao", price: 1.80 },
